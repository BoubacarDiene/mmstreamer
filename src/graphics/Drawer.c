...
/*!
* \file   Drawer.c
* \brief  Graphics elements renderer
...
static DRAWER_ERROR_E initScreen_f(DRAWER_S *obj, GFX_SCREEN_S *screenParams)
{
    ...
    int32_t videoFlags = SDL_HWSURFACE | SDL_DOUBLEBUF;
    ...
    if (access(screenParams->icon.path, R_OK) == 0) {
